...
date: '2023-05-20T17:21:00.000Z'
keywords: [clean code, kotlin, developer, code, typescript, programming, quality, agile, solid principle, dry principle, kiss principle, yagni principle]
tags: [code, principle]
pinned: false
...
<Image
  src="/static/images/blog/6-principles-of-software-engineering-you-may-know/bad-code.png"
...
<Image
  src="/static/images/blog/6-principles-of-software-engineering-you-may-know/solid.png"
  alt="SOLID Principle"
  width={1200}
  height={280}
  fill={false}
...
<div className="text-center">
  Source [medium.com](https://irmakesin.medium.com/solid-design-principles-explained-the-single-responsibility-principle-1cb999aa0aa6)
</div>
...
/**
 * The `Car` and `Motorcycle` classes are substitutable for their base class `Vehicle` without changing the behavior of the program.
