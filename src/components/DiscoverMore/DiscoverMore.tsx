  ...
  return (
    <Link href={href}>
      <div className='flex justify-center items-center cursor-pointer relative h-16 w-60 group'>
        <div className='w-16 h-16 opacity-80 bg-gray-300 dark:bg-gray-800 absolute rounded-full top-1/2 -translate-y-1/2 ml-0 transition-all duration-700 animate-pulse left-0 group-hover:left-3/4 group-hover:scale-105' />
