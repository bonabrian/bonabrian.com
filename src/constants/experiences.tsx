    ...
    stacks: [
      {
        name: 'Next.js',
        icon: (
          <NextJs className={cn('h-5 w-5 fill-black', 'dark:fill-white')} />
        ),
      },
      {
        name: 'React.js',
        icon: <ReactJs className={cn('h-5 w-5 fill-[#61DAFB]')} />,
      },
      {
        name: 'TypeScript',
        icon: <TypeScript className={cn('h-5 w-5 fill-[#3178C6]')} />,
      },
      {
        name: 'JavaScript',
      ...
      {
        name: 'Tailwind CSS',
        icon: <TailwindCss className={cn('h-5 w-5 fill-[#06B6D4]')} />,
      },
      {
        name: 'Laravel',
